				...
				<div class="page-inner">
						<div class="row">
							<div class="col-sm-6">
								<div class="card">
									<div class="card-body">
									<h5 class="card-title mb-2 fw-mediumbold">Form Stok Keluar</h5>
							...
							<div class="col-sm-6">
								<div class="card">
									<div class="card-body">
									<h5 class="card-title mb-2 fw-mediumbold">Daftar Keluar</h5>
									...
									<hr/>
									<form action="{{URL::to('/')}}/barangkeluarupdate" method="POST">
									@csrf
									<div class="form-group">
			...
			function getnama($id){
				$.ajax({
					...
					// console.log(data['nama']);
						...
						$("#stock").val(data['stok']);
						$("#jumlah").attr({
							"max" : data['stok'],        // substitute your own
							"min" : 0 
						});
					}
				});
