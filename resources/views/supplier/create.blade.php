							...
							<div class="card">
								...
								<div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Masukkan Nama Supplier">
                                        <span style="color: red">@error('nama') {{$message}} @enderror</span>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">No. Handphone</label>
                                        <input type="number" class="form-control @error('nama') is-invalid @enderror" name="no" placeholder="Masukkan No. Handphone">
